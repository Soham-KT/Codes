...
public class OwnerPage extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException, IOException {
        ...
        try {
            ...
            ResultSet res = stat.executeQuery("select password from owner_info where owner_name = '"+name+"';");
            ...
            if(!res.isBeforeFirst() && res.getRow() == 0){
                ...
                out.println("location='ownerPage.html';");
                out.println("</script>");
            }
                ...
                while (res.next()){
                    if(password.equals(res.getString("password"))){
                        ...
                        out.println("location='owner.jsp';");
                        out.println("</script>");
                    }
                }
                System.out.println("Login Fail");
